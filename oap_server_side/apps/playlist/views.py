...
class PlaylistViewSet(viewsets.ModelViewSet):
    ...
    def get_serializer_class(self):
        if self.action == 'retrieve':
            return PlaylistDetailSerializer  # Use detailed serializer for retrieve action that shows the associated playlistmedia
    ...
    def perform_create(self, serializer):
        ...
        # Prevent creating playlists of type 'WATCHLATER'
    ...
    def perform_destroy(self, instance):
        ...
        # Assuming that watch later playlists cannot be deleted
...
class PlaylistMediaViewSet(viewsets.ModelViewSet):
    ...
    def get_user_media(self, request, pk=None):
        ...
        user_media = Media.objects.filter(uploaderID=user)
        serializer = MediaSerializer(user_media, many=True)
        return Response(serializer.data)
