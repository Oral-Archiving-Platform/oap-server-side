from .views import VideoViewSet, TranscriptViewSet, VideoSegmentViewSet, ParticipantViewSet, ComplexSegmentViewSet
...
router.register(r'combined', ComplexSegmentViewSet, basename='combined')
